...
public class Google_StepDefinitions {
    ...
    public void userSearchesForCapital(String countryName) {
        System.out.println("What is capital city of " +
                countryName );
        searchPage.searchBar.sendKeys("What is capital city of " +
                countryName + Keys.ENTER);
    }

    @Then("User should see {string} in the result")
    public void userShouldSeeInTheResult(String capitalCity) {
        System.out.println("What is capital city of  +" + capitalCity );
