...
public class PercentageCalculatorStepDefs {
    ...
    public void user_should_see_following_calculations(Map<Integer, Integer> valuesMap) {
        ...
        for(Integer inputKey : valuesMap.keySet()) {
            ...
            System.out.println("ACTUAL 5% CALCULATED = " + calculatorPage.result.getAttribute("value"));
            System.out.println("=============================");
            //assert that expected %5 valur matches the actual calculated value.Then go home
